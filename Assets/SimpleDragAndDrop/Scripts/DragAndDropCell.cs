...
public class DragAndDropCell : MonoBehaviour, IDropHandler
{
    ...
    [HideInInspector]
    public NewInventorySlot inventorySlot;
    ...
    void Start()
    {
        ...
        inventorySlot = this.gameObject.GetComponent<NewInventorySlot>();
    }
                ...
                if ((item != null) && (sourceCell != this))
                {
                    ...
                    switch (cellType)                                       // Check this cell's type
                    {
                        case CellType.Swap:
                            ...
                            {
                                case CellType.Swap:
                                    if ((inventorySlot.slotType.ToString() != item.inventoryItem.itemType.ToString()) && (inventorySlot.slotType.ToString() != "common"))
                                        break;
